...
var
   ...
   begin
     down1 := (joystick1.axis[0] > 48000);
     up1 := joystick1.axis[0] < 10000;
   ...
   begin
     down2 := joystick2.axis[0] > 48000;
     up2 := joystick2.axis[0] < 10000;
